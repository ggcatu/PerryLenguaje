...
int main(){
	std::cout << getreg("a","a",0) << std::endl;
	std::cout << getreg("a","a",1) << std::endl;

	std::cout << getreg("b","b",0) << std::endl;
	std::cout << getreg("b","b",1) << std::endl;

	std::cout << getreg("c","c",0) << std::endl;
	std::cout << getreg("c","c",1) << std::endl;

	std::cout << getreg("d","d",0) << std::endl;
	std::cout << getreg("d","d",1) << std::endl;

	std::cout << getreg("f","f",0) << std::endl;
	std::cout << getreg("f","f",1) << std::endl;

	std::cout << getreg("m","m",0) << std::endl;
	std::cout << getreg("m","m",1) << std::endl;

	std::cout << getreg("j","j",0) << std::endl;
	std::cout << getreg("j","j",1) << std::endl;

	std::cout << getreg("s","s",0) << std::endl;
	std::cout << getreg("s","s",1) << std::endl;
}